...
public class Update
{
    ...
    public static void UpdateBook()
    {
        using (var context = new AppDbContext())
        {
            ...
            System.Console.WriteLine($"The Title is {updateBook.Title}\nEnter new Title to change to");
            ...
            context.SaveChanges();
            System.Console.WriteLine($"Renamed the book to {title} ");
        }
    }
    ...
    public static void UpdateAurthor()
    {
        using (var context = new AppDbContext())
        {
            ...
            {
                System.Console.WriteLine("The ID has not been found, try again ");
            ...
            context.SaveChanges();
            System.Console.WriteLine($"Changed it to {firstName} {lastName} ");
        }
    }
}
